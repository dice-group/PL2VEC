...
# Generate samples
sobol_sampled_parameters = pd.DataFrame(saltelli.sample(problem, 2), columns=['K',
                                                                              'energy_release_at_epoch',
...
representative_entities = analyser.pipeline_of_data_processing(learned_embeddings, num_sample_from_clusters)

analyser.pipeline_of_dl_learner(representative_entities)
